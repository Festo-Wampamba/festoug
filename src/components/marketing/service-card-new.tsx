...
export function ServiceCard({ title, icon, features, description }: ServiceCardProps) {
  return (
    <div className="group relative bg-eerie-black-1 border border-jet rounded-2xl p-6 md:p-8 overflow-hidden transition-all duration-300 hover:border-orange-yellow-crayola/50 hover:shadow-[0_0_20px_rgba(255,181,63,0.15)]">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-4 mb-6">
          <div className="flex items-center justify-center w-12 h-12 rounded-xl bg-orange-yellow-crayola/10 text-orange-yellow-crayola text-2xl">
            {icon}
          </div>
